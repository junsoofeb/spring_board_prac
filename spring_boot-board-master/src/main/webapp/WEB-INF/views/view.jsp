	...
	$
			.ajax({
				...
				success : function(result) {
					$("#image")
							.append(
									'<img src="C:/Users/USER/Documents/workspace-spring-tool-suite-4-4.10.0.RELEASE/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/spring_boot-board-master'
											+ result.image
											+ '" style="width: 100%;">');
